...
MyGame.prototype.initialize = function () {
   ...
   //新建文本4，此为英雄2的生命
    ...
    switch(player1)
    {
        case 1:this.mHero1 = new Hero1(50, 100,this.keyBoard1);
            break;
        case 2:this.mHero1 = new Hero2(50, 100,this.keyBoard1);
            break;
        case 3:this.mHero1 = new Hero3(50, 100,this.keyBoard1);
            break;       
    }
    
    switch(player2)
    {
        case 1 :  this.mHero2 = new Hero1(110, 100,this.keyBoard2);
            break;
        case 2 :  this.mHero2 = new Hero2(110,100,this.keyBoard2);
            break;
        case 3 :  this.mHero2 = new Hero3(110,100,this.keyBoard2);
            break;
    }
